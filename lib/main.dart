...
var kDarkColorScheme = ColorScheme.fromSeed(
    ...
    seedColor: const Color.fromARGB(150, 020, 150, 025));

void main() {
  /** putting our runApp() in this code fragment sets the device orientations
   * allowed for the app's layout. ie it ensures the app's layout
   * stays in the listed device orientations.
   * In this case, the only device orientation allowed is portraitUp.
   *
